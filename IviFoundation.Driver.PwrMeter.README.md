...
|field   | value |
|---     |  ---  |
|Title   | IVI PwrMeter Class CSSC |
|Description |IVI PwrMeter Class CSSC |
...
# IVI PwrMeter Class CSSC

The PwrMeter Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for an RF Power Meter. The PwrMeter class is designed to support typical RF Power Meters as well as common extended functionality found in more complex instruments.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
