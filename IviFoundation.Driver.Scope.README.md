...
|field   | value |
|---     |  ---  |
|Title   | IVI Scope Class CSSC |
|Description |IVI Scope Class CSSC |
...
# IVI Scope Class CSSC

The Scope Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for oscilloscopes. The Scope class is designed to support typical oscilloscopes as well as common extended functionality found in more complex instruments.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
