...
|field   | value |
|---     |  ---  |
|Title   | IVI Upconverter Class CSSC |
|Description |IVI Upconverter Class CSSC |
...
# IVI Upconverter Class CSSC

The Upconverter Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for up converters. The Upconverter class is designed to support devices that convert IF input frequency signals to RF output frequency signals.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
