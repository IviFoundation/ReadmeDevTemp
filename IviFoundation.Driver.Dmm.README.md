...
|field   | value |
|---     |  ---  |
|Title   | IVI Dmm Class CSSC |
|Description |IVI Dmm Class CSSC |
...
The Dmm Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for digital multimeters (DMMs). The Dmm class is designed to support typical DMMs as well as common extended functionality found in more complex instruments.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
