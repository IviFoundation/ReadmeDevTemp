...
|field   | value |
|---     |  ---  |
|Title   | IVI LxiSync Class CSSC |
|Description |IVI LxiSync Class CSSC |
...
# IVI LxiSync Class CSSC

The LxiSync Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide a common definition for the arming, triggering, and event functionality of LXI devices. For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
