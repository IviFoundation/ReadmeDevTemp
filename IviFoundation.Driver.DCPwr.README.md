...
|field   | value |
|---     |  ---  |
|Title   | IVI DC Power Class CSSC |
|Description |IVI DC Power Class CSSC |
...
# IVI DC Power Class CSSC

The IVI DC Power Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for DC Power Supplies. The DCPwr class is designed to support typical DC power supplies as well as common extended functionality found in more complex instruments.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
