...
|field   | value |
|---     |  ---  |
|Title   | IVI RFSigGen Class CSSC |
|Description |IVI RFSigGen Class CSSC |
...
# IVI RFSigGen Class CSSC

The RFSigGen Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for an RF Signal Generator. The RFSigGen class is designed to support typical RF Signal Generators as well as common extended functionality found in more complex instruments.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
