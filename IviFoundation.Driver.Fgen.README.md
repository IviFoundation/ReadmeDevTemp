...
|field   | value |
|---     |  ---  |
|Title   | IVI Fgen Class CSSC |
|Description |IVI Fgen Class CSSC |
...
The FGen Class CSSC (Configurable Settings Shared Components) packages contain libraries for the development and use of drivers that are migrated from IVI Generation 2014.

The libraries in this package provide an interchangeable definition for function generators. The Fgen class is designed to support typical function generators as well as common extended functionality found in more complex instruments.  For the detailed specification of the API see [IVI Specifications](https://www.ivifoundation.org/specifications/default.html).
